...
def scan_document(image: np.ndarray):
    """Detects document boundary and warps perspective."""
    ...
    if screenCnt is not None:
        ...
        # warped = cv2.adaptiveThreshold(warped_gray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 11, 2)
        # For now, return color warped
        return warped, 1.0, True
    else:
        return orig, 0.5, False
